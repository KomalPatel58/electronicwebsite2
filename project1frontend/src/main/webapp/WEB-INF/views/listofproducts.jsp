				...
				<c:forEach var="p" items="${productsList}">
					<tr >
						<td><a
							...
							<td><a
							href="<c:url value='/all/getproduct/${p.id }'></c:url>"><img src="<c:url value='/resources/images/${p.id}.png'></c:url>" height="30px" width="30px" alt="${p.id }"></a></td>
						<td><a
						  ...
						  <a href="<c:url value='/all/getproduct/${p.id }'></c:url>">
							<span class="glyphicon glyphicon-info-sign"></span></a> 
							  ...
							  <security:authorize access="hasRole('ROLE_ADMIN')">
								...
								<a href="<c:url value='/admin/getupdateproductform/${p.id }'></c:url>"><span
